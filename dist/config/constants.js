...
var DB_CONNECTION_STRING = exports.DB_CONNECTION_STRING = process.env.NODE_ENV === 'production' ? process.env.PROD_URL || 'localhost:27017' : process.env.DEV_URL || 'localhost:27017';
