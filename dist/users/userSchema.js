...
function UserSchema(_ref) {
    ...
    function getSaveUserMutation(outputViewer) {
        ...
        return (0, _graphqlRelay.mutationWithClientMutationId)({
            ...
            mutateAndGetPayload: function () {
                var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee(userArgs, param2, param3) {
                    var savedUser;
    ...
    function getAuthTokenMutation(outputViewer) {
        ...
        return (0, _graphqlRelay.mutationWithClientMutationId)({
            ...
            mutateAndGetPayload: function () {
                var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(form, param2, param3) {
                    var authToken;
